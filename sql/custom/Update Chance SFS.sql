...
UPDATE FROM creature_loot_template set `ChanceOrQuestChance`=@ChanceN WHERE `entry` IN (38297, 37959, 37506, 38550, 38586, 38785, 38436, 38267, 39168);
UPDATE FROM gameobject_loot_template set `ChanceOrQuestChance`=@ChanceN WHERE `entry` IN (28088, 28096);
