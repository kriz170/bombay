        ...
        case SPELLFAMILY_PALADIN:
        {
            ...
            switch (dummySpell->Id)
            {
                ...
                case 31801:
                {
                    ...
                    bool damager = procSpell && procSpell->Id != 31804;
                ...
                case 53736:
                {
                    ...
                    bool stacker = !procSpell || procSpell->Id == 53595;
                    // spells with SPELL_DAMAGE_CLASS_MELEE excluding Judgements
                    bool damager = procSpell && procSpell->Id != 53733;
...
uint32 Unit::SpellHealingBonusDone(Unit* victim, SpellInfo const* spellProto, uint32 healamount, DamageEffectType damagetype, uint32 stack)
{
    ...
    // No bonus healing for potion spells and Glyph of HL (hack fix)
    if (spellProto->SpellFamilyName == SPELLFAMILY_POTION || spellProto->Id == 54968)
        return healamount;
